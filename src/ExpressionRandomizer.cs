        ...
        readonly Dictionary<string, JSONClass> _builtInPresetJSONs = new Dictionary<string, JSONClass>
        {
            ...
            },
            {
                ...
                new JSONClass
                {
                    ...
                    [Name.MASTER_SPEED] = { AsFloat = 0.80f },
                    [Name.LOOP_LENGTH] = { AsFloat = 1.50f },
                    [Name.MORPHING_SPEED] = { AsFloat = 12.00f },
                    /* Enabled morphs */
            ...
            },
            {
                ...
                new JSONClass
                {
                    ...
                    [Name.PLAY] = { AsBool = true },
                    [Name.SMOOTH] = { AsBool = true },
                    [Name.RESET_USED_EXPRESSIONS_AT_LOOP] = { AsBool = false },
                    [Name.TRIGGER_TRANSITIONS_MANUALLY] = { AsBool = false },
                    [Name.RANDOM_CHANCES_FOR_TRANSITIONS] = { AsBool = true },
                    [Name.CHANCE_TO_TRIGGER] = { AsFloat = 75f },
                    [Name.MINIMUM_VALUE] = { AsFloat = -0.03f },
                    [Name.MAXIMUM_VALUE] = { AsFloat = 0.34f },
                    [Name.MULTIPLIER] = { AsFloat = 1.00f },
                    [Name.MASTER_SPEED] = { AsFloat = 2.80f },
                    [Name.LOOP_LENGTH] = { AsFloat = 3.00f },
                    [Name.MORPHING_SPEED] = { AsFloat = 2.00f },
                    /* Enabled morphs */
